...
/*
    ...
    // funcion para realizar laz conversio
...
*/
    ...
    // Rehacemos la formula
    let precioBtc = 20000;
    let precioEth = 2000;
    let resultado = 0; //--> en la primer version no tenia variable resultado
    let monto;

    function conversor(){
        monto = parseInt(document.querySelector('#monto').value); //--> si esta variable la declaraba afuera, me devolvia NaN. Por que? 

        if (document.querySelector('#USD').checked && document.querySelector('#BTC').checked){
            return resultado = monto / precioBtc ; // leugo cambiar a return e invocar en el h2 id ='resultado'
    ...
    btnConvertir.addEventListener('click', ()=> console.log(conversor())); 
    ...
    agregandoResulado = document.createElement('h3');
    //4) le agrego el contendio (resultado) con inner.HTML
    agregandoResulado.innerHTML = resultado; 
    //5) agregar el nodo HIJO al nodo PADRE
    document.body.append(agregandoResulado);
